...
const translations = {
  en: {
    ...
    'products.items.1.title': 'RimikoOS 10 V5 (Lightweight Edition)',
    'products.items.1.desc': 'The lightest remake of RimikoOS 10 V5, with deeper optimization than the original version, with a smaller installation file.',
  ...
  vi: {
    ...
    'products.items.1.title': 'RimikoOS 10 (Bản rút gọn)',
    'products.items.1.desc': 'Bản dựng lại nhẹ hơn của RimikoOS 10 V5, được tối ưu sâu hơn so với bản gốc, với tệp cài đặt nhỏ gọn hơn.',
