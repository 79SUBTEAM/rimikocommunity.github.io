...
const translations = {
  en: {
    ...
    'products.items.1.title': 'RimikoOS 10 V5 (21H2)',
    ...
    'products.items.2.title': 'RimikoOS 10 V5 (21H2, Lightweight Edition)',
    'products.items.2.desc': 'The lightest remake of RimikoOS 10 V5, with deeper optimization than the original version, and a smaller installation file.',
    'products.items.3.title': 'RimikoOS 11 V2 (24H2, NO DEFENDER)',
    'products.items.3.desc': 'The 2nd custom Windows we are making with our partner Moonie to create a good Windows Lite for users.',
    'products.items.4.title': 'RimikoOS 11 V2 (24H2, DEFENDER)',
    'products.items.4.desc': 'As same as the first one, this version includes Windows Defender for those who want security.',
    'products.items.5.title': 'RimikoOS 11 V3 (22H2, SUPERLITE)',
    'products.items.5.desc': 'The lightest custom of RimikoOS 11, with deeper optimization than the original version, and a smaller installation file.',
  ...
  vi: {
    ...
    'products.items.2.title': 'RimikoOS 10 V5 (21H2, Bản rút gọn)',
    ...
    'products.items.3.title': 'RimikoOS 11 V2 (24H2, Không Defender)',
    'products.items.3.desc': 'Bản Windows 11 tuỳ biến thứ hai hợp tác cùng Moonie, hướng đến hiệu năng nhẹ.',
    'products.items.4.title': 'RimikoOS 11 V2 (24H2, Có Defender)',
    'products.items.4.desc': 'Tương tự bản trên nhưng bao gồm Windows Defender cho nhu cầu bảo mật.',
    'products.items.5.title': 'RimikoOS 11 V3 (22H2, SUPERLITE)',
    'products.items.5.desc': 'Bản dựng lại nhẹ hơn của RimikoOS 11, được tối ưu sâu hơn so với bản gốc, với tệp cài đặt nhỏ gọn hơn.',
