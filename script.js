...
const translations = {
  en: {
    ...
    'products.items.2.title': 'RimikoOS 10 V5 (Lightweight Edition)',
    ...
    'products.items.3.title': 'RimikoOS 11 V2 (NO DEFENDER)',
    ...
    'products.items.4.title': 'RimikoOS 11 V2 (DEFENDER)',
  ...
  vi: {
    ...
    'products.items.4.title': 'RimikoOS 11 V2 (Có Defender)',
